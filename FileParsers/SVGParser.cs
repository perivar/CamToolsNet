...
namespace SVG
{
    ...
    public class SVGDocument
    {
        ...
        static void ProcessSVG(XElement element, int depth, SVGDocument doc, string layerName, Matrix matrix, Dictionary<string, SVGStyle> styleDictionary, string imageDirectoryPath)
        {
